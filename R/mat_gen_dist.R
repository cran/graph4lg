...
#' (Dyer et Nason, 2004).}
#' \item{If 'dist = 'DPS'', then the genetic distance used is akin to
#' 1 - the proportion of shared alleles (Bowcock, 1994). The formula used
#' is the same as in the MSA software.}
